// Example aerodrome-themed crypto tokens (use real or fictional tokens)
const tokens = [
  { id: 'aviate', name: 'Aviate', symbol: 'AVI' },       // Fictional
  { id: 'airportcoin', name: 'AirportCoin', symbol: 'APC' }, // Fictional
  { id: 'helium', name: 'Helium', symbol: 'HNT' },        // Real token (example use)
  { id: 'jetcoin', name: 'Jetcoin', symbol: 'JET' }       // Real token
];
